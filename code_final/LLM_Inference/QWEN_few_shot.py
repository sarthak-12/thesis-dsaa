...
### Few‑Shot Prompt Version ###
def build_prompt_few_shot(row):
    example1 = (
        "Example 1:\n"
    ...
    example2 = (
        "Example 2:\n"
        "<Numerical Data>: \"Open: 3200; sentiment_volatility_lag1: 1; aggregate_sentiment_score_lag1: -1; "
        "Close_lag1: 3190; High_lag1: 3210; Volume_lag1: 280000000; Daily_Return_lag1: -5; Volatility_lag1: 0\"\n"
        "<News Article>: Analysts warn of a market downturn amid global economic uncertainty.\n"
        "</Answer/>: down\n\n"
    )
    ...
    prompt = (
        ...
        "Respond with exactly one word ('up' or 'down') on a new line. Do not echo any part of this prompt or the above examples.\n"
...
def main():
    ...
    prompt_builder = build_prompt_few_shot  # change as needed
    
    output_file = "fold_wise_predictions_few_shot.jsonl"
